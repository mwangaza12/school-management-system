...
<form action="{{ route('courses.store')}}" method="POST">
  ...
  <div class="mb-4">
    ...
    <input type="text" id="code" name="code" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Enter code">
  </div>
